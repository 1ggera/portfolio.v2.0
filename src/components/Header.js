    ...
    <Stack>
      ...
      <Flex direction={isNotSmallerScreen ? "row" : "column"} spacing="200px" p={isNotSmallerScreen ? "32" : "0"} alignSelf="flex-start">
        ...
        <Box mt={isNotSmallerScreen ? "0" : 16} align='flex-start'>
          ...
          {/* descripción */}
          <Text color={isDark ? "gray.200" : "gray.500"} fontSize="2xl">Welcome user. You are not a robot<br/>Escribeme si necesitas alguna herramienta digital. <br/>Estaré encantado de conocerte</Text>
