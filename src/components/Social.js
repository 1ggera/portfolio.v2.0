...
function Social(){
  return (
    <HStack spacing="8">
      ...
      <IconButton as={FaInstagram} boxSize="49" borderRadius={'32%'} _hover={{ bgGradient: "linear(to-r, cyan.400, purple.500)" }} onClick={() => window.open("https://www.instagram.com/digital.gera/")}></IconButton>
    </HStack>
  )
}
